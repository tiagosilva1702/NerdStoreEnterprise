...
namespace NSE.Identidade.API.Controllers
{
    ...
    {
        private readonly SignInManager<IdentityUser> _singInManage;
        ...
        public async Task<ActionResult> Login(UsuarioLogin usuarioLogin)
        {
            ...
            var result = await _singInManage.PasswordSignInAsync(usuarioLogin.Email, usuarioLogin.Senha, false, true);
